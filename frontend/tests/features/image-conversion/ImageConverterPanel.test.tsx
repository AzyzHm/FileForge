...
import { ImageConverterPanel } from "../../../src/features/image-conversion/ImageConverterPanel";

vi.mock(
  "../../../src/features/image-conversion/imageConversionService",
  async () => {
    const actual = await vi.importActual<
      typeof import("../../../src/features/image-conversion/imageConversionService")
    >("../../../src/features/image-conversion/imageConversionService");
    return {
      ...actual,
      convertImage: vi.fn(),
...
import { convertImage } from "../../../src/features/image-conversion/imageConversionService";
