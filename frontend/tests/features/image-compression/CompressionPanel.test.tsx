...
import { CompressionPanel } from "../../../src/features/image-compression/CompressionPanel";

vi.mock(
  "../../../src/features/image-compression/compressionService",
  async () => {
    const actual = await vi.importActual<
      typeof import("../../../src/features/image-compression/compressionService")
    >("../../../src/features/image-compression/compressionService");
    return {
      ...actual,
      compressImage: vi.fn(),
...
import { compressImage } from "../../../src/features/image-compression/compressionService";
