...
import { PdfCompressionPanel } from "../../../src/features/pdf-compression/PdfCompressionPanel";

vi.mock(
  "../../../src/features/pdf-compression/pdfCompressionService",
  async () => {
    const actual = await vi.importActual<
      typeof import("../../../src/features/pdf-compression/pdfCompressionService")
    >("../../../src/features/pdf-compression/pdfCompressionService");
    return {
      ...actual,
...
import { compressPdfOnServer } from "../../../src/features/pdf-compression/pdfCompressionService";
