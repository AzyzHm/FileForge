...
import { BackgroundRemovalPanel } from "../../../src/features/background-removal/BackgroundRemovalPanel";

vi.mock(
  "../../../src/features/background-removal/backgroundRemovalService",
  async () => {
    const actual = await vi.importActual<
      typeof import("../../../src/features/background-removal/backgroundRemovalService")
    >("../../../src/features/background-removal/backgroundRemovalService");
    return {
      ...actual,
...
import { removeImageBackground } from "../../../src/features/background-removal/backgroundRemovalService";
