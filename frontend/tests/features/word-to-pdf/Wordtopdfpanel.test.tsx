...
import { WordToPdfPanel } from "../../../src/features/word-to-pdf/WordToPdfPanel";

vi.mock("../../../src/features/word-to-pdf/wordToPdfService", async () => {
  const actual = await vi.importActual<
    typeof import("../../../src/features/word-to-pdf/wordToPdfService")
  >("../../../src/features/word-to-pdf/wordToPdfService");
  return {
    ...actual,
...
import { convertDocxToPdf } from "../../../src/features/word-to-pdf/wordToPdfService";
