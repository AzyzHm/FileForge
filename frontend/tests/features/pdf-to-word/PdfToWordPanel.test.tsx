...
import { PdfToWordPanel } from "../../../src/features/pdf-to-word/PdfToWordPanel";

vi.mock("../../../src/features/pdf-to-word/pdfToWordService", async () => {
  const actual = await vi.importActual<
    typeof import("../../../src/features/pdf-to-word/pdfToWordService")
  >("../../../src/features/pdf-to-word/pdfToWordService");
  return {
    ...actual,
...
import { convertPdfToWord } from "../../../src/features/pdf-to-word/pdfToWordService";
